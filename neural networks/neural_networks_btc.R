...
#before continuing we will need to import the external regressors we will use to fit our arima model, which will be one of the nodes of our neural network. 
#we read them in a separate script, and then import them here. 
...
fsi = fsi %>%
  ...
  complete(Date = seq.Date(as.Date("2010-07-19"), as.Date("2017-12-23"), 1))
